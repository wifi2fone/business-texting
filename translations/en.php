...
define("MESSAGE_VERIFICATION_MAIL_SENT", "Your account has been created successfully and we have sent you an email. Your part of us now.");
...
define("MESSAGE_USERNAME_INVALID", "Username does not fit the name scheme: only numbers are allowed, 9 to 64 characters");
...
define("WORDING_NEW_USERNAME", "New username (username cannot be empty and must be 09 and 2-64 characters)");
...
define("WORDING_REGISTRATION_USERNAME", "Enter Your Cell Phone Number (this will be your userID)");
